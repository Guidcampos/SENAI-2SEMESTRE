...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "API para o projeto health clinic - Backend API",
...
.AddJwtBearer("JwtBearer", options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("healthclinic-chave-autenticacao-webapi")),
        //Tempo de expiração do token
        ClockSkew = TimeSpan.FromMinutes(5),
        //Nome da issuer, de onde está vindo
        ValidIssuer = "healthclinic.tarde",
        //Nome da audience, de onde está vindo
        ValidAudience = "healthclinic.tarde"
    };
});
